...
const styles = StyleSheet.create({
  ...
  cardTitle: { flex: 1, color: '#181C1C', fontFamily: fonts.regular, fontSize: 18, lineHeight: 23 },
  ...
  metricLabel: { color: '#424841', fontFamily: fonts.regular, fontSize: 11, lineHeight: 16, opacity: 0.6 },
  ...
  date: { color: '#737971', fontFamily: fonts.regular, fontSize: 11, lineHeight: 17 },
  ...
  syncText: { color: '#466349', fontFamily: fonts.regular, fontSize: 11, lineHeight: 17 },
