...
export const lightColors = {
  ...
  card: '#FFFFFF',
  cardTemp:'#FFFFFF',
  cardSecondary: '#fdfffd',
  cardSecondaryHome:'#eff1f2',
  text: '#181C1C',
  textSecondary: '#596159',
  border: '#E3E8E3',
  brand: '#466349',
  brandSoft: 'rgba(232, 240, 234, 0.28)',
  brandSoftIcon: 'rgba(232, 240, 234, 0.58)',
  danger: '#C43D3D',
  dangerSoft: '#F8EAEA',
...
export const darkColors = {
  ...
  cardSecondaryHome:'#26302A',
  text: '#F0F5F0',
  textSecondary: '#B5C0B7',
  border: '#37443C',
  brand: '#81ec7d',
  brandSoft: 'rgba(37, 66, 45, 0.18)',
  brandSoftIcon: 'rgba(37, 66, 45, 0.52)',
  danger: '#FF9B94',
  dangerSoft: '#4A2929',
