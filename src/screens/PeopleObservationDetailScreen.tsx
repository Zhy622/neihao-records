...
const createStyles = (colors: AppColors) => ({
  ...
  cardLabel: { color: colors.text, fontFamily: fonts.medium, fontSize: 14 },
  cardValue: { color: colors.text, fontFamily: fonts.regular, fontSize: 14, lineHeight: 23 },
  ...
  reflectionLabel: { color: colors.text, fontFamily: fonts.medium, fontSize: 14 },
